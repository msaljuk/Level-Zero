...
public:	
	...
	void AddToBuyStation(FName Name, TEnumAsByte<ItemType> Type, FText ItemDescription, TSubclassOf<USAction> ActionClass, int Cost = 0, float Duration = -1.0f, bool IsAlreadyPurchased = false);
